...
class HighSchoolLogin extends StatefulWidget {
  static const routeName = '/high-school-login';

  @override
  State<HighSchoolLogin> createState() => _HighSchoolLoginState();
}

class _HighSchoolLoginState extends State<HighSchoolLogin> {
  @override
    ...
    try {
      ...
      try {
        ...
        if (AdminLogin['email'].toString() == _authData['email'] &&
          ...
          Navigator.of(context).pushNamed('/high-school-staff');
        } else {
          Navigator.of(context).pushNamed('/user-high-school');
        }
      } catch (e) {
