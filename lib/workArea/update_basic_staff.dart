...
class UpdateBasicStaff extends StatefulWidget {
  // String id;
  static const routeName = '/update-basic-staff';

  @override
  State<UpdateBasicStaff> createState() => _UpdateBasicStaffState();
}

class _UpdateBasicStaffState extends State<UpdateBasicStaff> {
  ...
  void submitStaffData() async {
    if (_formKey.currentState!.validate()) {
      ...
      // Navigator.of(context).pop();
      Navigator.of(context).pop();
      // .pushReplacementNamed(BasicSchoolStaffAdmin.routeName);
    }
  }
