...
class UserProfileBasicShool extends StatefulWidget {
  static const routeName = '/user-basic';

  @override
  @override
  State<UserProfileBasicShool> createState() => _UserProfileBasicShoolState();
}

class _UserProfileBasicShoolState extends State<UserProfileBasicShool> {
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            //           .pushNamed(UpdateBasicUser.routeName,
