...
class BasicSchoolUser extends StatefulWidget {
  static const routeName = '/basic-user';

  @override
  State<BasicSchoolUser> createState() => _BasicSchoolUserState();
}

class _BasicSchoolUserState extends State<BasicSchoolUser> {
