...
import '../models/high_school_class.dart';
import '../models/high_school_class_staff.dart';
import 'high.dart';

class HighSchoolStaffAdmin extends StatefulWidget {
  static const routeName = '/high-school-staff';

  @override
  State<HighSchoolStaffAdmin> createState() => _HighSchoolStaffAdminState();
}

class _HighSchoolStaffAdminState extends State<HighSchoolStaffAdmin> {
  Future<void> _refreshProduct(BuildContext context) async {
    try {
      await Provider.of<PHSS>(context, listen: false).fetchAndSetHighStaff();
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          Padding(
            ...
            child: IconButton(
                onPressed: () =>
                    Navigator.of(context).pushNamed('/HighSchoolStaff-Add'),
                icon: Icon(
                  Icons.person_add,
                  color: oxblood,
                )),
                                      ...
                                      Card(
                                          ...
                                          child: ListTile(
                                            ...
                                            trailing: IconButton(
                                              ...
                                              onPressed: () {
                                                Navigator.of(context).pushNamed(
                                                    UpdateHighSchoolStaff
                                                        .routeName,
                                                    arguments: staffDetails
                                                        .staff[i].id
                                                        .toString());
                                              },
                                            ),
