...
class UserHighSchoolProfile extends StatefulWidget {
  static const routeName = '/User-high-school';

  @override
  State<UserHighSchoolProfile> createState() => _UserHighSchoolProfileState();
}

class _UserHighSchoolProfileState extends State<UserHighSchoolProfile> {
  ...
  Future<void> _deleteStaff(BuildContext context, String staffid) async {
    ...
    await Provider.of<PHSS>(context, listen: false).deleteProduct(staffid);
    setState(() {
      isLoading = false;
    });
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (staffid != null) {
        _editedStaff = Provider.of<PHSS>(context, listen: false)
  ...
  Future<void> updatestaffInfo(
    ...
    if (staff['trackingDate'].toString().isNotEmpty && diff.inDays >= 20) {
      ...
      if (diff.inDays >= 20 &&
        ...
        final url1 =
            'https://phrankstarmanagement-default-rtdb.firebaseio.com/HighSchool/$id.json';
  ...
  Future<void> updateStaffAllowance(Map<String, String> staff) async {
    ...
    if (diff.inDays >= 365 &&
      ...
      final url6 =
          'https://phrankstarmanagement-default-rtdb.firebaseio.com/HighSchool/$id2.json';
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            //           .pushNamed(UpdateHighSchoolUser.routeName,
                            ...
                            actions: [
                              ...
                              TextButton(
                                  onPressed: () {
                                    Navigator.of(context, rootNavigator: true)
                                        .pop();
                                    disablestaff(_initValues, context);
                                  },
                                  child: Text(
                                    'OKAY',
                                    style: TextStyle(color: oxblood),
    ...
    pw.Page(
      ...
      build: (pw.Context context) {
        return pw
          ...
          pw.Center(
              child: pw.Text('PHRANKSTARS HIGH SCHOOL',
                  style: pw.TextStyle(
...
Future<void> disablestaff(Map<String, dynamic> staff, BuildContext ctx) async {
  String? id2;
  id2 = staff['id'];
