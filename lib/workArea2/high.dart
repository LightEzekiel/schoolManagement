...
import 'update_high_staff.dart';

class HighSchoolStaffProfileAdmin extends StatefulWidget {
  static const routeName = '/High-school-admin';
  @override
  State<HighSchoolStaffProfileAdmin> createState() =>
      _HighSchoolStaffProfileAdminState();
}

class _HighSchoolStaffProfileAdminState
    extends State<HighSchoolStaffProfileAdmin> {
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            //           .pushNamed(UpdateHighSchoolStaff.routeName,
