...
class UpdateHighSchoolUser extends StatefulWidget {
  static const routeName = '/high-school-update-user';

  @override
  State<UpdateHighSchoolUser> createState() => _UpdateHighSchoolUserState();
}

class _UpdateHighSchoolUserState extends State<UpdateHighSchoolUser> {
  ...
  void submitStaffData() async {
    if (_formKey.currentState!.validate()) {
      ...
      Navigator.of(context).pop();
      // Navigator.of(context).pushReplacementNamed(HighSchoolUser.routeName);
    }
  }
