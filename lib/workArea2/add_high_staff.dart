...
class AddHighSchoolStaff extends StatefulWidget {
  static const routeName = '/HighSchoolStaff-Add';

  @override
  State<AddHighSchoolStaff> createState() => _AddHighSchoolStaffState();
}

class _AddHighSchoolStaffState extends State<AddHighSchoolStaff> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Add High School Staff'.toUpperCase(),
